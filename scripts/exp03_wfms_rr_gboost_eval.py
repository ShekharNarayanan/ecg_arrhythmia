...
waves_rr_gboost_model  = config["waves_rr_gboost_model"]
waves_rr_gboost_features = config["waves_rr_gboost_features"]

# load model
clf = joblib.load(waves_rr_gboost_model)

# load cached features
data = joblib.load(waves_rr_gboost_features)
X_test = data["X_test"]
y_test = data["y_test"]
